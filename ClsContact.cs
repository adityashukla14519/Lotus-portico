...
public class ClsContact
{
    ...
    public DataSet getBookingDetail(int Action, string FromDate, string ToDate,int Id)
    {
        ...
        DbCommand cmd = db.GetStoredProcCommand("getBookRoom");
    ...
    {
        Database db = DatabaseFactory.CreateDatabase();
        DbCommand cmd = db.GetStoredProcCommand("SaveUpdateBookRoom");
        db.AddInParameter(cmd, "@Action", DbType.Int32, Action);
        db.AddInParameter(cmd, "@Id", DbType.Int32, Id);
        ...
        db.AddInParameter(cmd, "@EntryDate", DbType.String, EntryDate);
        db.AddInParameter(cmd, "@ExitDate", DbType.String, ExitDate);
        db.AddInParameter(cmd, "@Adults", DbType.Int32, Adults);
        db.AddInParameter(cmd, "@Children", DbType.Int32, Children);
